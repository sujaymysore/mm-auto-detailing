...
export const GALLERY_SLOTS: GallerySlotData[] = [
  ...
  { src: galleryAsset("SilverX5_CeramicProofVid1_Gallery.MOV"), video: true },
  { src: galleryAsset("cayennesnowfoam.jpeg") },
  { src: galleryAsset("forestercoatingproofvideo.MOV"), video: true },
  { src: galleryAsset("GreyCLA_CeramicProofVid2_Gallery.MOV"), video: true },
